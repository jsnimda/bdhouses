...
module.exports = {
  ...
  methods: {
    ...
    control_chart: function(val){
      var rect = this.$refs.chart.querySelectorAll('.canvasjs-chart-canvas')[1].getBoundingClientRect();
      this.$refs.chart.querySelectorAll('.canvasjs-chart-canvas')[1].dispatchEvent(new MouseEvent("mousemove", {
        view: window,
        bubbles: true,
        cancelable: true,
        clientX: rect.left + rect.width * val / 1000,
